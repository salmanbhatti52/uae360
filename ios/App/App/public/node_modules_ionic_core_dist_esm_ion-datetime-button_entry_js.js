...
/* harmony import */ var _parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./parse-decd0f85.js */ 60669);
...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
      ...
      const parsedDatetimes = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.p)(parsedValues.length > 0 ? parsedValues : [(0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.f)()]);
      /**
      ...
      const use24Hour = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.H)(locale, hourCycle); // TODO(FW-1865) - Remove once FW-1831 is fixed.
      ...
      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.R)(locale, firstParsedDatetime);
          const timeText = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.I)(locale, firstParsedDatetime, use24Hour);
        ...
        case 'date':
          if (multiple && parsedValues.length !== 1) {
            ...
            this.dateText = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.R)(locale, firstParsedDatetime);
          }

          break;

        case 'time':
          this.timeText = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.I)(locale, firstParsedDatetime, use24Hour);
          break;

        case 'month-year':
          this.dateText = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.E)(locale, firstParsedDatetime);
          break;

        case 'month':
          this.dateText = (0,_parse_decd0f85_js__WEBPACK_IMPORTED_MODULE_6__.Q)(locale, firstParsedDatetime, {
            month: 'long'
          });
          break;
    ...
    this.waitForDatetimeChanges = /*#__PURE__*/(0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
    ...
    this.handleDateClick = /*#__PURE__*/function () {
      var _ref2 = (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
        const {
          datetimeEl,
          datetimePresentation
        } = _this;
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
