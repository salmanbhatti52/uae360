...
/* harmony import */ var _index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-fe2c1c1f.js */ 24293);
...
/* harmony import */ var _overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-6ab11907.js */ 16419);
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./theme-7670341c.js */ 50320);
/* harmony import */ var _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-fbafcf43.js */ 28592);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const getScrollY = () => {
    if (contentEl && (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
  ...
  const canStart = detail => {
    ...
    contentEl = (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.f)(target);
    ...
    if (contentEl) {
       ...
       * asynchronous.
       */
      if ((0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
  ...
  const onStart = detail => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }
  ...
  const onEnd = detail => {
    ...
    if (contentEl) {
      (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialScrollY);
    }
...
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  ...
  const wrapperAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  const wrapperAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.g)(presentingEl);
    const presentingAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().afterStyles({
          transform: finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_5__.g)(presentingEl);
    const presentingAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const createEnterAnimation = () => {
  ...
  const wrapperAnimation = (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  return (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  return (0,_animation_e5036198_js__WEBPACK_IMPORTED_MODULE_11__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const Modal = class {
  ...
  present() {
    ...
    return (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_10__.e)(_this3.usersElement);
  ...
  initSwipeToClose() {
    ...
    const contentEl = (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.a)(el);

    if (!contentEl) {
      (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.p)(el);
      return;
    }
