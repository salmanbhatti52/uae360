...
/* harmony import */ var _overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./overlays-87c7c7cb.js */ 32752);
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./theme-7670341c.js */ 50320);
/* harmony import */ var _index_eab49c64_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-eab49c64.js */ 31856);
/* harmony import */ var _animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./animation-6a1a2a1d.js */ 88211);
...
/* harmony import */ var _index_f8d8aa5a_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./index-f8d8aa5a.js */ 69286);
...
const StatusBar = {
  ...
  getStyle: function () {
    var _ref = (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const engine = this.getEngine();
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss) => {
  ...
  const gesture = (0,_index_f8d8aa5a_js__WEBPACK_IMPORTED_MODULE_14__.createGesture)({
    el,
...
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  ...
  const wrapperAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  const wrapperAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_5__.g)(presentingEl);
    const presentingAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().afterStyles({
          transform: finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_5__.g)(presentingEl);
    const presentingAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const createEnterAnimation = () => {
  ...
  const wrapperAnimation = (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  return (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  return (0,_animation_6a1a2a1d_js__WEBPACK_IMPORTED_MODULE_12__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.e)(el);
    configureTriggerInteraction();
  }
  ...
  present() {
    ...
    return (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_index_eab49c64_js__WEBPACK_IMPORTED_MODULE_11__.e)(_this3.usersElement);
      (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => _this3.el.classList.add('show-modal'));
      _this3.currentTransition = (0,_overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.d)(_this3, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, statusBarStyle, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  dismiss(data, role) {
    ...
    return (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const enteringAnimation = _overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.h.get(_this6) || [];
      _this6.currentTransition = (0,_overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.f)(_this6, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
  ...
  onDidDismiss() {
    return (0,_overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.g)(this.el, 'ionModalDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_87c7c7cb_js__WEBPACK_IMPORTED_MODULE_9__.g)(this.el, 'ionModalWillDismiss');
  }
  /**
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
