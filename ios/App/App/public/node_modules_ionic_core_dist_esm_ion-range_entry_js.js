...
const Range = class {
  constructor(hostRef) {
    ...
    this.setupGesture = /*#__PURE__*/(0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    this.contentEl = (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_fe2c1c1f_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialContentScrollY);
    }
