...
/* harmony import */ var _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-fbafcf43.js */ 28592);
...
const Nav = class {
  ...
  componentDidLoad() {
    ...
    return (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.gesture = (yield __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-9347ea5f.js */ 20374))).createSwipeBackGesture(_this2.el, _this2.canStart.bind(_this2), _this2.onStart.bind(_this2), _this2.onMove.bind(_this2), _this2.onEnd.bind(_this2));
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.d);
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.b);
        (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.c);
        (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.d);
  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,D_Github_Projects_360UAE_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const {
        hasCompleted
      } = yield (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.t)(animationOpts);
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.l)(element, _index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.d);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          (0,_index_fbafcf43_js__WEBPACK_IMPORTED_MODULE_5__.s)(element, true);
        }
      }
    }
  }
